...
public class GameManager : MonoBehaviour
{
    ...
    // int til antal af genafspildning f�rste gang = 1
    public int playCount { get; private set; } = 1;
    // tilf�j liste af string til scene navn. scene navn f�s af Choice button som sender choicedata
    ...
    private void Start()
    {
        //tilf�jer int'en for antallet af genafspildning til listen af strings af scene navne.  
        //sceneHistory.Add(playCount.ToString());
        //gemme value a, b og c i start v�rdier variabler a,b og c
        start_valueA = valueA;
        start_valueB = valueB;
        start_valueC = valueC;
    }
    ...
    public void ApplyChoice(ChoiceData choice)
    {
        ...
        {
            // tilf�jer choicedatas scene navn til listen
